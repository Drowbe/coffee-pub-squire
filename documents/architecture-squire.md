...
| Health | window-health.js | Blacksmith Application V2 Micro tool window with a dedicated body template, multi-token controls, and registration against every displayed Actor |
