...
### Fixed
- **The import report no longer vanishes before it is read.** It was an auto-dismissing notification carrying a list of item names the player has to act on — the list left with it. It stays until dismissed now.
