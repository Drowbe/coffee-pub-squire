...
- **The tray handle is rebuilt: 60px, one layout, laid out top to bottom.** It was a 42px column of nine identical squares, authored upside down, with a rotated character name taking roughly a third of its height.
  ...
  - **Pin and collapse are adjacent, at the top.** They were at opposite ends of the strip — the caret at the foot to mirror core Foundry's sidebar collapse — which put the two controls that do the same category of thing the full height of the screen apart.
